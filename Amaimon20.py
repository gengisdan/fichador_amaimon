...
print("CÓMO CITAR ESTE SOFTWARE: Granados, Daniel. 2019. Amaimon, software para la recuperación automática de datos. Versión: 2.0. Lenguaje: Python. México. https://github.com/gengisdan/fichador-amaimon")
